...
{
    public class MasterKeyV2 : MasterKeyV1
    {
        public override KeyVersion AlgorithmVersion => KeyVersion.V2;

        public MasterKeyV2(string fullName) : base(fullName)
        {
        }
        ...
        public override string Encode(string siteName, SiteType siteType, uint siteCounter, SiteVariant siteVariant, string siteContext = null)
        {
            ...
            var siteNameLengthBytes = BytesForInt(siteNameBytes.Length);
